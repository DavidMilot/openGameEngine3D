...
namespace openGameEngine3D
{
	...
	void WindowsWindow::Init (const WindowProps& props)
	{
		...
		if (s_GLFWWindowCount == 0)
		{
			...
			OGE_PROFILE_SCOPE ("glfwInit");

			#if defined(OGE_DEBUG)
			...
			//OGE_CORE_ASSERT (success, "Could not initial GLFW!");
			//std::cout << success << "Could not initial GLFW!";
			glfwSetErrorCallback (GLFWErrorCallback);
		}

		{
			OGE_PROFILE_SCOPE ("glfwCreateWindow");
